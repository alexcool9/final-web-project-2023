...
const Products = ({products, layout, onLike, onDelete, isDelete}) => {
    ...
    return (
        <div id="services" className="bg-gray-100 w-full" >
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold"><span className='font-black'>Safety</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                When it comes to safety, the first step is to find an essential oil company you can trust. Because essential oils can be contaminated or compromised during the extraction process, it’s important to verify sourcing ethics and practices. Those with a strict protocol will produce oils that are consistently authentic, providing you with an experience you can count on.                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold"><span className='font-black'>Healthy</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
